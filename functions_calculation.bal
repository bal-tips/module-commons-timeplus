...
# + return - The resulting UTC time or an error if the civil time conversion fails
@display {label: "Add Duration", iconPath: "icon.png"}
public isolated function add(@display {label: "UTC Time"} time:Utc utcTime, @display {label: "Duration"} Duration duration) returns time:Utc|time:Error {
